...
class CleanFeatureExtractor:
    ...
    def _validate_recall_data(self):
        ...
        if missing_type or missing_time or missing_words or missing_emb:
            print("\n⚠️  WARNING: Some recalled items are missing metadata!")
            print(
                "This will cause features to be 0/NaN and may hurt model performance."
            )
            print("Possible causes:")
            print(
                "  1. Data loading inconsistency between recall and feature extraction"
            )
            print("  2. Recall results contain items not in article database")
            print("  3. Debug mode sampling mismatch")
